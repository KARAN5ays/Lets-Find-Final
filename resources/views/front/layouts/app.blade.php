...
<head>
	...
	<title>Let's Find | Find Best Jobs</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">Let's Find</a>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© Let's Find Company, all right reserved</p>
</div>
</footer> 
