...
Route::get('/upload-cv',[ CvController::class,'showForm'])->name('upload.cv.form');
Route::post('/upload-cv',[CvController::class,'uploadCV'])->name('upload.cv');
Route::delete('/delete-cv/{id}',[CvController::class,'deleteCV'])->name('delete.cv');
Route::get('/cv/{id}',[CvController::class,'viewCV'])->name('view.cv');
